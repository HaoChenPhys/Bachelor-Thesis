...
Potts model and derive the corresponding fermionic representation. Thereafter we summarize the analytical results from Ref.~\inlinecite{Roland2021Hyperbolic,Roland2021Percolation}.
